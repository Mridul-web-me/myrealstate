...
var VanillaTabs = function () {
    function e(t) {
        ...
        this.options = Object.assign({
            ...
            responsiveBreak: 840,
            activeIndex: 0
        }, t), this.elems = document.querySelectorAll(this.options.selector), this.skipIfInitialized = function (e) {
            e.classList.contains("tabs__initialized")
        }, this.buildUI(), this.handleNavigation(), this.handleResponsive()
    }
    return _createClass(e, [{
            ...
            this.elems.forEach((function (t, s) {
                ...
                for (var l = 0; l < i.length; l++) {
                    ...
                    if (c.nodeType != Node.TEXT_NODE) {
                        ...
                        n.push(o);
                        var _ = c.innerHTML;
                        c.innerHTML = '<div class="tabs__content_wrapper">' + _ + "</div>", c.insertAdjacentHTML("afterbegin", '<a class="tabs__nav_link">' + o + "</a>")
                    }
                }
                var v = "";
        ...
        value: function () {
            ...
            t.forEach((function (t, a) {
                var i = t;
                e.skipIfInitialized(i), i.addEventListener("click", (function (e) {
                    if (e.target && e.target.classList.contains("tabs__nav_link")) {
                        var t;
                        e.preventDefault(), t = "tabs__nav" == e.target.parentElement.classList ? Array.prototype.slice.call(e.target.parentElement.children).indexOf(e.target) : Array.prototype.slice.call(e.target.parentElement.parentElement.children).indexOf(e.target.parentElement) - 1;
                        ...
                        if (("accordion" == s || i.classList.contains("is__responsive")) && e.target.classList.contains("is__active")) return a[t].classList.remove("is__active"), n[t].classList.remove("is__active"), void r[t].classList.remove("is__active");
                        for (var l = 0; l < a.length; l++) a[l].classList.remove("is__active");
                        a[t].classList.add("is__active"), n.forEach((function (e) {
                            e.classList.remove("is__active")
                        })), n[t].classList.add("is__active"), r.forEach((function (e) {
                            e.classList.remove("is__active")
        ...
        value: function () {
            ...
            window.addEventListener("resize", (function () {
                t.forEach((function (t, a) {
                    ...
                    (e.skipIfInitialized(i), window.innerWidth > Number(e.options.responsiveBreak)) ? (i.classList.remove("is__responsive"), "accordion" != s && 0 == i.querySelectorAll(".tabs__nav_link.is__active").length && (n[0].classList.add("is__active"), r[0].classList.add("is__active"), l[0].classList.add("is__active"))) : i.classList.add("is__responsive")
                }))
